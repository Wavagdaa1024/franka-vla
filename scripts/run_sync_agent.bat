...
echo ===============================================================================
echo   FRANKA VLA SYNCHRONOUS AGENT (GPU 1, RTX 5090 32GB)
echo   Protocol: Stop-and-Go (Zero Timestamp Race, Zero Motion Blur, High Precision)
echo ===============================================================================
...
"%PY%" -u scripts\python\sync_vla_agent.py %*
exit /b %errorlevel%
